    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2">
          <label className="block text-sm font-medium text-fg-2 mb-1">รายการ</label>
          <input
            type="text"
            name="text"
            value={form.text}
        ...
        {/* วันที่กำหนด */}
        <div>
          <label className="block text-sm font-medium text-fg-2 mb-1">วันที่กำหนด</label>
          <input
            type="date"
            name="due_date"
            value={form.due_date}
        ...
        {/* เวลากำหนด */}
        <div>
          <label className="block text-sm font-medium text-fg-2 mb-1">เวลากำหนด</label>
          <input
            type="time"
            name="due_time"
            value={form.due_time}
        ...
        {/* วันที่สิ้นสุด */}
        <div>
          <label className="block text-sm font-medium text-fg-2 mb-1">วันที่สิ้นสุด</label>
          <input
            type="date"
            name="end_date"
            value={form.end_date}
